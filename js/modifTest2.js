...
let nomJoueurA = document.getElementById('nomJoueurA')
let nomJoueurB = document.getElementById('nomJoueurB')
...
const incrementerScorePrenomA = function () {
    //PointsA_Invisible()
...
const incrementerScorePrenomAB = function () {
    //PointsB_Invisible()
    ...
    scoresPointB.style.display = 'block'
};
*/
...
const resetHTML = function () {
    location.href = "http://127.0.0.1:5500/jeux.html";
    //window.onload();
